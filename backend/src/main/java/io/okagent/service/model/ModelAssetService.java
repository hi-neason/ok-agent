...
public class ModelAssetService {
  ...
  @Transactional
  public ModelAssetResponse create(ModelAssetRequest r) {
  ...
  @Transactional
  public ModelAssetResponse update(UUID id, ModelAssetRequest r) {
    var a = find(id);
    a.update(
        r.name(), r.type(), r.provider(), r.modelId(), r.endpoint(), r.secretRef(), r.enabled());
    return ModelAssetResponse.from(a);
  }
