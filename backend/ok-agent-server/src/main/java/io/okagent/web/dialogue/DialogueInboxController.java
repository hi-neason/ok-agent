...
@RestController
@RequestMapping("/api/v1/inbox/sessions")
@Validated
public class DialogueInboxController {
    ...
    @GetMapping
    public PageResponse<DialogueWorkItemView> list(
        ...
        return PageResponse.of(workItems.list(
    ...
    public DialogueWorkItemView get(@PathVariable String sessionId) {
        return workItems.get(sessionId);
    }
    ...
    public DialogueWorkItemView assign(
        ...
        return workItems.assign(sessionId, request.assigneeAccountId(), actorId(jwt));
    }
    ...
    public DialogueWorkItemView transition(
        ...
        return workItems.transition(sessionId, request.status(), actorId(jwt));
    }
    ...
    public DialogueWorkItemView changePriority(
        ...
        return workItems.changePriority(sessionId, request.priority(), actorId(jwt));
    }
