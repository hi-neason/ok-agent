...
class RemoteErrorSanitizerTests {
    ...
    void removesCommonSecretFragmentsFromVisibleRemoteBodies() {
        String message = RemoteErrorSanitizer.http(
                "Dify",
                400,
                "{\"api_key\":\"sk-secret\",\"token\":\"tok-secret\",\"secret\":\"very-secret\",\"password\":\"pw-secret\",\"detail\":\"bad input\"}",
                "check key");
        ...
        assertThat(message).doesNotContain("sk-secret", "tok-secret", "very-secret", "pw-secret");
    }
