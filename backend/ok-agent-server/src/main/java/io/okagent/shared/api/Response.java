...
public record Response<T>(boolean success, String code, String message, T data, Instant timestamp, String path) {
    ...
    public static <T> Response<T> success(T data, String path) {
        return new Response<>(true, "OK", "success", data, Instant.now(), path);
    }
    ...
    public static Response<Void> error(String code, String message, String path) {
        return new Response<>(false, code, message, null, Instant.now(), path);
    }
