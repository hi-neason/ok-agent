...
public class AccountController {
    ...
    public ApiResponse<PageResponse<AccountResponse>> list(
        ...
        return ApiResponse.success(PageResponse.of(accountService.list(page, size)));
    }
    ...
    public ApiResponse<AccountResponse> create(
        ...
        return ApiResponse.success(accountService.create(actor(jwt), request));
    }
    ...
    public ApiResponse<AccountResponse> update(
        ...
        return ApiResponse.success(accountService.update(id, actor(jwt), request));
    }
