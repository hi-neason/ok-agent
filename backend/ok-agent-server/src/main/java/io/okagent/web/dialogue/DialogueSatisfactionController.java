...
import io.okagent.service.dialogue.DialogueSatisfactionService;
import io.okagent.service.dialogue.DialogueSatisfactionView;
...
@RestController
@RequestMapping("/api/v1/inbox/sessions/{sessionId}/satisfaction")
