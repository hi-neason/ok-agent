...
public class AccountController {
    ...
    public AccountResponse update(
        ...
        return accountService.update(id, UUID.fromString(jwt.getClaimAsString("accountId")), request);
    }

    /** Replaces an interactive account password without returning credential material. */
    @PutMapping("/{id}/password")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void changePassword(@PathVariable UUID id, @Valid @RequestBody AccountPasswordRequest request) {
