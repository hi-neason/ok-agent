...
import io.okagent.service.customerwork.CustomerCaseService;
import io.okagent.service.customerwork.CustomerCaseView;
...
@RestController
@RequestMapping("/api/v1/inbox/sessions/{sessionId}/cases")
